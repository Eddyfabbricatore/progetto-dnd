...
@section('content')
    ...
    <form action="{{ route("characters.update", $character) }}" method="POST">
        ...
        <div class="mb-3">
            ...
            <input type="text" class="form-control" id="height" name="height" value="{{ old("height", $character->height) }}">
            {{-- @error("height")
                <p class="text-danger">{{$message}}</p>
            @enderror --}}
        </div>
        ...
        <div class="mb-3">
            ...
            <input type="text" class="form-control" id="weight" name="weight" value="{{ old("weight", $character->weight) }}">
            {{-- @error("weight")
                <p class="text-danger">{{$message}}</p>
            @enderror --}}
        </div>
        ...
        <div class="mb-3">
            ...
            <input type="text" class="form-control" id="armor_class" name="armor_class" value="{{ old("armor_class", $character->armor_class) }}">
            {{-- @error("armor_class")
                <p class="text-danger">{{$message}}</p>
            @enderror --}}
        </div>
        ...
        <div class="mb-3">
            ...
            <input type="text" class="form-control" id="str" name="str" value="{{ old("str", $character->str) }}">
            {{-- @error("str")
                <p class="text-danger">{{$message}}</p>
            @enderror --}}
        </div>
        ...
        <div class="mb-3">
            ...
            <input type="text" class="form-control" id="dex" name="dex" value="{{ old("dex", $character->dex) }}">
            {{-- @error("dex")
                <p class="text-danger">{{$message}}</p>
            @enderror --}}
        </div>
        ...
        <div class="mb-3">
            ...
            <input type="text" class="form-control" id="con" name="con" value="{{ old("con", $character->con) }}">
            {{-- @error("con")
                <p class="text-danger">{{$message}}</p>
            @enderror --}}
        </div>
        ...
        <div class="mb-3">
            ...
            <input type="text" class="form-control" id="int" name="int" value="{{ old("int", $character->int) }}">
            {{-- @error("int")
                <p class="text-danger">{{$message}}</p>
            @enderror --}}
        </div>
        ...
        <div class="mb-3">
            ...
            <input type="text" class="form-control" id="wis" name="wis" value="{{ old("wis", $character->wis) }}">
            {{-- @error("wis")
                <p class="text-danger">{{$message}}</p>
            @enderror --}}
        </div>
        ...
        <div class="mb-3">
            ...
            <input type="text" class="form-control" id="cha" name="cha" value="{{ old("cha", $character->cha) }}">
            {{-- @error("cha")
                <p class="text-danger">{{$message}}</p>
            @enderror --}}
        </div>
